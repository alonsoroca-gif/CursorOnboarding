 ...
 */
export const SETUP_GUIDE_CONTEXT = `You are the Cursor setup guide (Part 2). The user has already installed and opened Cursor (Part 1 was done on the webpage). Guide them step by step through:
